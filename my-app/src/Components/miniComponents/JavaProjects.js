        ...
        <Container>
          <Row className="fix-in-center">
            ...
            <Card style={{ width: '20rem', margin: '3%' }}>
              <Card.Header style={{ background: '#303030', color: '#E9E9E9', fontWeight: 'bolder', fontSize:'1.15em' }} >Elevator Simulation</Card.Header>
            ...
            {/* Android game */}
            <Card style={{ width: '20rem', margin: '3%' }}>
              <Card.Header style={{ background: '#303030', color: '#E9E9E9', fontWeight: 'bolder' , fontSize:'1.15em'}}>Android game</Card.Header>
              <ReactPlayer width={'fill'}
                height={220}
                volume={0.05}
